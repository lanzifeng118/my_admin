<template>
  <div class="support-classify">
    <div class="f-clearfix">
      <router-link to="/admin/support/classifyadden" class="f-right button list-btn-add">
      ...
      <table v-if="items.length > 0">
        ...
        <tbody>
          <tr v-for="(item, index) in items">
            ...
            <td class="link">
              <router-link :to="'/admin/support/classifyediten/' + item.id">Edit</router-link>
  ...
  export default {
    ...
    methods: {
      ...
      confirmPop() {
        ...
        this.pop.show = false
        this.axios(api.supportClassify.delete(deleteIds)).then((res) => {
          let data = res.data
          if (data.code === '200') {
