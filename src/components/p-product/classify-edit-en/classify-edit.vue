...
<div class="edit product-classify-edit">
  ...
  <router-link to="/admin/product/classifyen" class="edit-close-btn" >
  ...
  <div class="edit-table-wrap">
    <table>
      <tbody>
        ...
        <!-- fullName -->
        <tr>
          <td width="100"><span class="icon-nessisary"></span>Full Name</td>
        ...
        <!-- logo -->
        <tr>
          <td class="vertical-top">Logo Pic<span class="separate"></span></td>
          <td>
            <edit-pic
              logo="true"
              boxWidth="300"
        ...
        <!-- banner_img -->
        <tr>
          <td class="vertical-top">Banner Pic<span class="separate"></span></td>
          <td>
            <edit-pic
              boxWidth="650"
              boxHeight="100"
...
export default {
  ...
  methods: {
    getItem() {
      if (this.$route.path === '/admin/product/classifyadden') {
        return
      }
      this.typeAdd = false
      let _this = this
    ...
    goBack() {
      let _this = this
      setTimeout(() => {
        _this.$router.push('/admin/product/classifyen')
      }, 700)
    },
